...
class ImageDownloader:
    ...
    def __init__(self, timeout: float = 30.0, max_size_mb: int = 50, verify_ssl: bool = False):
        """
        ...
        Args:
            ...
            verify_ssl: Verify SSL certificates (default: False for local dev)
        """
    ...
    async def download_image(self, url: str) -> Image.Image:
        ...
        try:
            ...
            # UPDATE: Added verify=self.verify_ssl
    ...
    def download_image_sync(self, url: str) -> Image.Image:
        ...
        try:
            ...
            with httpx.Client(timeout=self.timeout, verify=self.verify_ssl) as client:
                ...
                # ... (rest of the code remains the same as async version) ...
                # Check content length
                content_length = response.headers.get("content-length")
                if content_length:
                    size = int(content_length)
